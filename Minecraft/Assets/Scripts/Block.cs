...
public class Block {
	...
	public enum BlockType {GRASS, DIRT, STONE, WATER, AIR};
	...
	Vector2[,] blockUVs = { 
		...
		/*WATER*/			{new Vector2( 0, 0.375f ), new Vector2( 0.0625f, 0.375f),
								new Vector2( 0, 0.4375f ),new Vector2( 0.0625f, 0.4375f )}
						}; 
